...
```{r top_worldCountries}
top_worldCountries%>%filter(confirmed>=20000)%>%dplyr::mutate(country = factor(Country.Region, levels = Country.Region))%>% 
plotly::plot_ly(
                x = ~country,
                y = ~active,
                name = 'Ativos',
