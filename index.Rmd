...
```{r map}
cabo_verde_map%>% mutate(c_acumulados=replace_na(c_acumulados,0))%>% 
...
* _Fork_ o [repositório do dashboard](https://github.com/marovski/covid19-caboverde-dashboard) ou;
