...
plotly::plot_ly(data = joint_s,
  ...
  plotly::layout(title = "",
         ...
         xaxis = list(title = "Data"),
         hovermode = "compared",  annotations = list(
                  text = paste0("Última Atualização:", format(max(total_nacional$Data), '%d/%m'), sep = " "),
                   xref = "paper",
                   yref = "paper",
                   showarrow = FALSE,
...
plotly::plot_ly(
 ...
 # plotly::add_trace(y = ~recovered, name = 'Recuperados',  
 #            legendgroup = 'Recuperados', showlegend = FALSE,
 #            fillcolor = 'rgba(255, 188, 101, 0.8)',
 #            hovertemplate = paste('<i>Data</i>: %{x}',
 #                                  '<br><i>Recuperados</i>: %{y: .2f}%'))%>%
  plotly::layout(
    title = "<b>PALOP-TL</b>",
