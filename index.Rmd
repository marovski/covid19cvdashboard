...
### Factor de Crescimento de Novos Casos
```{r dailygrowth}
...
cabo_verde_map%>% mutate(`Casos Confirmados`=replace_na(c_acumulados,"Sem casos"))%>%
  mapview::mapview(legend=TRUE,zcol = "Casos Confirmados",raster.palette = grey.colors,
...
plotly::plot_ly(data = africa_daily,
                ...
                type = 'scatter',
                mode = 'none', 
                stackgroup = 'one',frame = ~as.Date(date)) %>%
