...
```{r}
valueBox(value = paste0(format(791, big.mark = ",")," (Até 24/04)"),caption = "Testes Realizados",icon = "fas fa-user-md", color = tested_color)
```
...
Row
--------------------------------------------------------------
### Países com mais de 20 000 casos
...
plotly::plot_ly(
  ...
  plotly::add_trace(y = ~recovered,
   ...
   plotly::layout(title = "",
                 ...
                 hovermode = "compare", 
                 annotations = list(
                   text = paste0("Última Atualização:", format(max(world_daily$date), '%d/%m'), sep = " "),
                   xref = "paper",
                   yref = "paper",
                   showarrow = FALSE,
                   x = 0.95,
...
Os dados brutos do pacote [covid19cvdata](https://github.com/marovski/covid19cvdata) são obtidos do website [covi19.cv](https://covid19.cv) e os dados do pacote [coronavirus](https://github.com/RamiKrispin/coronavirus) do Centro de Ciência e Engenharia da Universidade Johns Hopkins (JHU CCSE).
